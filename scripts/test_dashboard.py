...
def main() -> None:
    ...
    r = client.get("/dashboard/api/water-sources")
    gj = r.json()
    ...
    # Timeseries
    r = client.get("/dashboard/api/timeseries?days=14")
    ts = r.json()
    ...
    if "--slow" in sys.argv:
        ...
        if wsid:
            r = client.get(f"/dashboard/api/cog/{wsid}/stats")
            ...
            r = client.get(f"/dashboard/api/cog/{wsid}/0.png")
    ...
    if gj.get("features"):
        ...
        r = client.get(f"/dashboard/api/zones/{zid}")
